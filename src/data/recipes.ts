...
export const RECIPE_FOODS: Food[] = [
  ...
  },
  {
    ...
    macros: { calories: 470, protein: 21, carbs: 38, fat: 24, fiber: 2, sodium: 900 },
    note: "Single-serving recipe — the whole thing is one burrito. Upstream gives a calorie range (450–490 kcal); midpoint used, as with the beef burrito. Fibre and sodium estimated from the ingredient list: a ~65 g flour tortilla, sized from the stated carbs, carries nearly all the fibre (~2 g) and ~470 mg of the sodium, plus 2 large eggs (~140 mg), ~15 g marble cheese (~90 mg) and salsa (~50 mg). The recipe's \"pinch of salt\" is the least certain input, taken as ~1/16 tsp (~150 mg). Upstream notes that the cheese, the oil the eggs soak up and tortilla size (80–100 kcal between a 10\" and a 12\") move the calories most. Salsa was halved from 1 tbsp to ~1/2 tbsp on August 8, 2026, on the cook's own account of how much actually goes in; it is worth 50 mg, so it moves the total from 950 to 900 and settles nothing about the size of that total. The tortilla is the entry to argue with if 900 looks wrong, since it is over half the figure, and it is the best-corroborated line in it: USDA's refrigerated flour tortilla row is 683 mg/100 g (444 mg at 65 g) and a Mission 10\" burrito tortilla is 590 mg at 71 g, so 470 mg sits between a generic and a brand-name reading rather than above either. No hot sauce has ever been in this ingredient list; adding any would raise the figure, not lower it.",
