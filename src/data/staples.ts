...
export const PACKAGED_FOODS: Food[] = [
  ...
  {
    id: "pkg-sbux-iced-chai-latte-grande",
    name: "Iced Chai Tea Latte",
    variant: "Grande, 2% milk",
    brand: "Starbucks",
    source: "packaged",
    per: "1 grande (16 fl oz)",
    macros: {
    ...
    note: "Starbucks' US panel via search summaries on Sep 26; their site was blocked. Summaries split 7–8 g protein, 44–45 g carbs and 110–115 mg sodium; the lower set adds up to 240 exactly. Most of the sugar is the chai concentrate, not the milk.",
    tags: ["starbucks", "chai", "latte", "tea", "iced", "drink"],
  },
  {
  ...
  {
    id: "pkg-frelighsburg-the-glace-du-verger",
    name: "Thé glacé du verger",
    variant: "apple iced tea",
    brand: "Maison de la pomme de Frelighsburg",
    source: "packaged",
    per: "1 bottle (350 mL)",
    macros: {
      calories: 80,
    ...
    note: "Read off the bottle on Sep 25; the panel is for the whole 350 mL bottle. The sugar is mostly apple juice, but the label lists cane sugar too, whatever the retailers say about no added sugar.",
    tags: ["drink", "iced tea", "apple", "pomme", "verger", "frelighsburg", "quebec", "bottled", "sugar"],
  },
  {
