# Training Plan Handoff Document

Context document for a health dashboard project. Covers the athlete's goals, constraints, full program, progression rules, and the reasoning behind design choices. Written August 2026.

---

## 1. Athlete Profile

- **Training experience:** Intermediate. Runs a structured 4-day split and progresses linearly on main lifts.
- **Key physical note: hypermobility.** This shapes several program rules (see Section 7). End range of motion is larger than it should be, so joints need muscles working under tension near (not at) end range. Passive stretching is out. Hard lockouts are out.
- **Schedule:** 4 gym sessions per week (2 upper, 2 lower; each has a heavy and a light day). Off days are home-only, capped at ~20 minutes, and must be low intensity because the athlete is usually sore.
- **Home equipment:** one 25 lb kettlebell, one 35 lb kettlebell, a yoga mat, one weak resistance band. No gym visits on off days.
- **Gym equipment notes:** leg curls are done on a lying machine (only one available). Squats are on a Smith machine. Sled is available and liked.
- **Preference:** no exercise gets more than 2 sets, except bench press. Two sets is easier to lock in mentally, so both sets must be treated as real work sets.

## 2. Goals and Deadline

Deadline: **end of December 2026** (about 5 months from program start in early August).

| Goal | Baseline (Aug 2026) | Target | On pace? |
|---|---|---|---|
| Trap bar deadlift | 260 lbs x 5 | 300 lbs x 5 | Yes (~2 lbs/week) |
| Smith machine squat | 185 lbs x 5 | 225 lbs x 5 | Yes (~2 lbs/week) |
| Bench press | 165 lbs x 5 | 225 lbs x 5 | **Stretch goal.** 195–205 x 5 by December is realistic; 225 likely lands in spring. |
| Pullups | 7 bodyweight reps | 10 bodyweight reps | Yes |
| Dips | 10 bodyweight reps | 10 reps | **Already achieved.** Maintain. |
| Vertical jump | — | In-game dunk | Skill + power goal; progress tracked by approach jump attempts |

Two goals trade off: gaining bodyweight helps the bench and hurts the dunk. The athlete should decide which goal owns the fall. Food and sleep will decide most of the bench outcome.

## 3. The Program

Days are slotted into the week by the athlete. Three scheduling rules:

1. Don't stack heavy lower right after light lower.
2. Give bench a day or two between sessions.
3. Weekend sessions are fasted, so only the light days go there; heavy days are weekdays. *(Added September 7, 2026 — see Section 10.)*

### Heavy Lower

| Order | Exercise | Sets x Reps | Notes |
|---|---|---|---|
| 1 | Sled push + pull | 5–10 min | Warmup |
| 2 | Seated pancakes | ~5 min | Lower back warmup |
| 3 | Jumps | 2 x 4 | **Bodyweight only.** No kettlebell, no box, no drop. Quick dip to about a quarter squat — hips back, arms swing down and up fast, dip takes under a second. Not a slow, deep squat descent. Full rest between sets. These prime the nervous system for deadlifts; they do not drain it. |
| 4 | Trap bar deadlift | 2 x 5 | The two most important sets of the week. Add 2.5–5 lbs when both sets move well. |
...
| Order | Exercise | Sets x Reps | Notes |
|---|---|---|---|
| 1 | Sled + seated pancakes | as above | |
| 2 | Depth jumps | 2 x 5 | Step off, land, explode up immediately. If a rep feels slow, end the set. Long rests. |
| 3 | Weighted jumps | 2 x 5 | **After** depth jumps, never superset. Every rep fast. |
| 4 | Approach jumps at a rim | ~5 min | Only if rim access. This is skill practice, like shooting practice — not conditioning. Dunking is a skill and the actual movement must be rehearsed. |
| 5 | Trap bar deadlift | 2 x 5 | 80–85% of heavy-day weight. Fast, crisp bar speed. |
...
|---|---|---|---|
| 1 | Sled | 5–10 min | |
| 2 | Shoulder warmup | ~5 min | External rotations etc. |
...
| Order | Exercise | Sets x Reps | Notes |
|---|---|---|---|
| 1 | Sled + shoulder warmup | | |
| 2 | Pullups | 2 sets | Every few weeks, make one set an all-out test to track progress toward 10. |
...
### Off Day A — Jump Support (~15 min, home)

| Exercise | Sets x Reps | Notes |
|---|---|---|
| Pogo hops | 2 x 20 | Stiff ankles, minimal knee bend, quick off the ground. Springy, not high. Builds tendon stiffness without soreness. |
...
### Off Day B — Upper Support (~15 min, home)
...
Loaded stretching suits hypermobility: the muscle under tension protects the joint, which is why this is fine while passive stretching is not. Rules: move slow, stop at the **first real stretch** (never max range — the athlete's end range is past where it should be), and never push into sharp or pinchy joint sensations (that means the stretch has drifted past muscle range into joint range; back off an inch).

| Exercise | Dose | Target |
|---|---|---|
| Goblet squat pry (25 lb) | 2 x 45 sec | Hips + ankles for squatting |
| Long lunge hold | 2 x 30 sec/side | Hip flexors, for jumping. Add the bell if easy. |
| Slow single-leg RDL (35 lb) | 5/side, 5 sec down | Hamstrings for the deadlift. Pause at bottom stretch. |
| Bent-knee calf stretch on step | 2 x 8/side, 3 sec pause | Achilles for the jump |
| Kettlebell pullover (25 lb) | 2 x 8, 3 sec down | Lats + chest — hits pullups, bench, and dips at once |
| Deep pushup hold | 2 x 15–20 sec | Bottom of bench and dips. Kneel if needed. |
| Prying floor press stretch | 20 sec/side | Chest opener |

Short-on-time version: pullover, goblet pry, calf stretch.

If wrecked: walk 30 minutes instead. Recovery beats one more session.

### Away From the Gym (travel weeks, no equipment)

A trip is not a deload and not a layoff — it is a maintenance week. Six days should
cost little, but **the log does not yet show that and this section used to claim it
did**: it cited the August 5–13 gap ending with the trap bar moving better at the
same 260. The 260 was a typo, corrected on August 14 — the session was 240, the
...
- **Pullups:** progress through frequency, not grinding. Most sets stay at 4–5 clean reps; an all-out test set every few weeks tracks the path to 10. Optional: add 2 easy pullup sets at the start of lower days if elbows feel good.
- **Deload:** every 4–5 weeks, take a lighter week — same exercises, weight dropped 10–15%. Joints need it more than most people's given the hypermobility, and the bar usually moves faster the week after.
- **Basketball:** counts as fatigued jump work. On days the athlete plays, drop that day's off-day session.
- **November option:** once the base is built, a few jumps at the end of one session per week can practice expressing power while tired. Finishing touch, not main work.

## 5. Design Rationale (why the plan looks this way)
...
## 6. Open Item: the Ankle Drill

The athlete swapped single-leg calf raises for the **knee-to-wall drill** (a.k.a. weightbearing dorsiflexion lunge). Flag raised: knee-to-wall trains *range*, and the calf raises trained *strength* — different jobs, and with hypermobility, range is usually the thing already in surplus.

**Test:** stand facing a wall, foot about 4 inches away, drive the knee over the toes without the heel lifting.
- Touches the wall easily → ankles aren't stiff; the drill won't do much. Skip it.
- Can't touch → do it, 2 x 10 slow per side.

Either way, the two-leg loaded calf raise stays in the Off Day A slot, because the Achilles is a big part of the jump and pogos alone only cover part of it. Tibialis raises were dropped by the athlete's choice.

## 7. Hypermobility Rules (apply everywhere)

1. Stop just short of full lockout on bench, dips, and any pressing.
2. On bench: shoulder blades pinned; don't sink the bar so deep the shoulders roll forward. If the front of the shoulder starts complaining as volume climbs, this bottom position is the first thing to check.
3. No long passive stretching. Loaded/tension stretching only.
4. In stretching: stop at the first real stretch, never max range. Sharp or pinchy joint sensation = drifted past muscle into joint range; back off.
5. Controlled tempos throughout.
6. Carries, overhead holds, and Copenhagen planks double as joint-stability work.
7. Deload weeks matter more than they would for most lifters.

## 8. What a Dashboard Should Track

Suggestions for the health dashboard this document feeds:

- **Weekly working weights** on trap bar deadlift, Smith squat, and bench (heavy-day top sets), plotted against the linear pace lines: deadlift 260→300, squat 185→225 (both ~2 lbs/week through December), bench 165→~200 by December.
- **Pullup test-set reps** (the periodic all-out set), path from 7 → 10.
- **Jump quality, not just volume** — e.g., a per-session note on whether depth-jump reps stayed fast, and best approach-jump result at the rim (rim grab → hang → dunk attempt milestones).
- **Deload weeks** on the calendar every 4–5 weeks, with a check that they actually happened.
- **Off-day compliance** (A / B / stretch day / walk / basketball), since basketball substitutes for that day's session.
...
*Superseded on September 7 by Section 10 and `data/last-stretch.csv`: the 14th runs at 270 and 185 rather than 260 and 180, at the owner's call that the belt should show early, the belt jump moved to the 22nd, and the standing week changed shape so the light days fall on the fasted weekend. The table below stays as the first draft rather than being quietly rewritten.*
...
**The shape of a week.** Weekends are the likeliest training days and they are fasted, which the light days tolerate and the heavy days should not have to. So the standing week is: Monday stretch under tension, Tuesday heavy lower, Wednesday Off A, Thursday heavy upper, Friday Off B, Saturday light lower, Sunday light upper. Light lower takes Saturday rather than Sunday so the legs get two days before Tuesday's heavy lower; bench sits Thursday and Sunday, three and four days apart. Two weeks break the shape. The first week back runs on weekdays because that weekend is spoken for: heavy lower on the 14th, heavy upper on the 17th and again on the 21st (the trip puts the next bench ten days out, and it is the lift behind on volume), light lower on the 18th — which work moved to Saturday the 19th, swapping it with that day's Off A and landing it where the standing shape has it, with nothing downstream shifted — and the belt jump on the 22nd, the day before the trip. The deload week moves its heavy days to Monday and Tuesday because October 14–16 are away.

**The line.** Belt on September 14 at the weights the lifts already own: trap bar 270, the weight that produced the September soreness, and squat 185, the baseline the goals file has claimed since August. September 22 takes the belt jump, one 10 lb step on each: 280 and 195. That revises Section 9.2's cap once and only once, and it is conditional: the 14th has to move well and the back has to say nothing on the 15th and 16th, or the 22nd repeats the 14th and every later row slides a week. After that, five pounds a heavy session. The deload sits in the week of October 12 so the October 14–16 off days fall inside it, which costs the block three days it would have spent lightly anyway. Block 2 is where the goals close.

| Heavy lower | Trap bar | Squat | Leg curl | Note |
|---|---|---|---|---|
| Mon Sep 14 | 270 | 185 | 120 | Belt on. Beltless ramp first. |
| Tue Sep 22 | 280 | 195 | 125 | The belt jump, the day before the trip. |
| Tue Sep 29 | 285 | 200 | 125 | First uninterrupted week, on the standing Tuesday. |
| Tue Oct 6 | 290 | 205 | 130 | |
| Tue Oct 13 | 250 | 175 | 110 | Deload; Oct 14–16 off inside the week. |
| Tue Oct 20 | 295 | 210 | 130 | |
| Tue Oct 27 | **300** | 215 | 135 | Trap bar goal. Held at 300 from here; the back's budget goes to the squat. |
| Tue Nov 3 | 300 | 220 | 135 | |
| Tue Nov 10 | 300 | **225** | 140 | Squat goal, and the end of the stretch. |

Pullups: 2 × 5 on heavy upper, two sets on light upper, and Section 4's optional two easy sets at the start of lower days, now listed in the program so the session card can see them. Tests as set one of a Sunday light upper on October 4 (nine), October 25 (nine or ten) and November 8 (ten, the goal). Bench: 165 on September 17 and again on the 21st, then five pounds a heavy upper with a hold every third session, 150 in the deload week: 175 by early October, 185 by early November, 200 in the second week of December if it keeps going. It is a rider, not a condition.

**The accessories (September 17, 2026).** Asked for the same evening, after a heavy upper on which the cable row went 130 × 5 × 2 for the seventh session running, clean every time and never stepped, because the plan had a number for the bench and none for the row. The question was what to lift on everything else to serve the goals. The straight answer is that there is no such number: no load on a row or a curl produces a bench in a way anyone can program to, and the literature on accessory dose is thin enough that a figure would be invented. What the accessories do is three narrower jobs, and each job gives a rule. The row is the bench's counterweight — it keeps the shoulder centred as pressing volume climbs, which the hypermobility rules care about more than the bench does — so it should rise *with* the bench rather than ahead or behind it; a 5-rep row sitting around 80–85% of the 5-rep bench is the usual mark for a balanced shoulder, and 130 against 160 is 81%. The pulldown is the one accessory with a direct line to a goal: it is the pullup with the load dialled, and a lifter pulling down near bodyweight for 5 is normally past ten pullups. The curl and the Y raise are insurance, for the elbows under pullup volume and the shoulder under bench volume, and insurance that gets progressed like a goal becomes a fourth load on the joint it was meant to protect. Dips are already at target and stay there.
...
Deloads take every accessory down 10–15% with the main lifts, and the row holds rather than steps on the first heavy upper after one, as the bench does. A set that is not clean repeats the number, and if the bench slides a week the row slides with it — the ratio is the thing being kept, not the figure. These live in `data/last-stretch.csv` from September 21 in six columns of their own, blank on every earlier row because no accessory plan existed for those days, and the page grades a logged accessory against them the way it grades the main lifts. The stretch still ends when the three goals close; nothing here extends it.

**The weighted jump, and the audit that found it (September 19, 2026).** Asked for the same day the September 18 light lower was performed a day late: a prescription for *every* lift in the remaining schedule, not only the ones a goal is named after. Checking the program against `data/last-stretch.csv` movement by movement, the September 17 pass turns out to have covered the upper days and left the lower ones alone, which was mostly fine — the trap bar, the squat and the leg curl already carried a number on every lower row, and so did the optional pullups. Every other lift without one is a lift that should not have one: the sled and the pancakes are timed, the heavy day's jumps say *bodyweight only, no kettlebell, no box, no drop* in their own note, the depth and approach jumps are bodyweight by construction, and the off-day and stretch loads are fixed in `src/data/program.ts` where they belong — a 35 lb bell for the calf raises, 25 for the overhead hold and the goblet pry — because none of them is progressed. That left exactly one: the weighted jump, which has carried two 20 lb dumbbells since August 23 and never moved, for the same reason the cable row sat at 130 for seven sessions. Nothing said to move it.

The answer is that it should not move. The weighted jump is a speed lift — the light day's own blurb says every rep is fast and the set ends when one feels slow — and load and speed trade against each other directly. Forty pounds against a 186 lb bodyweight is about 21%, the top of the band where a loaded jump is still a jump rather than a slow squat done badly, and a lifter with the trap bar climbing five pounds a heavy session does not need a fourth progressing load on the same hips and knees. That is the argument Section 7 and the accessory table above already make. So it goes in as a rule of the same shape the Y raise and the fly take: **20 lbs a hand, held for the whole stretch, 15 on a deload** — 15 rather than 17 because the racks step in fives. If bodyweight drops the relative load rises on its own and still needs no step. Revisit only if the depth jumps are consistently at full dose *and* the trap bar is ahead of its line, and even then the case is thin.

| Movement | Rule | Line |
|---|---|---|
| Weighted jumps | Hold 20 a hand, light lower only. Never stepped to chase a jump; the load is capped by what keeps the rep fast. | 20 throughout, 15 on a deload |

It lives in a `weighted_jumps` column in `data/last-stretch.csv`, inserted after `leg_curl` rather than appended so the lower-day loads stay together, filled on the light lower days only and blank before October 3 — the same rule the accessory columns took, no plan written in after the fact for days already run. Grading a jump against it meant letting the `jump` kind into the day card's logged-lift list, which had been compounds and isolations only; the bodyweight jumps now show their sets there with no verdict, which is right.

**The line redrawn (September 22, 2026).** The belt jump went ahead: trap bar 280 × 5 for one set, hard with maybe a rep left. The second set dropped to 260 and lost form on the fifth rep, and the squat was cut to 135 for 2 × 5 after it. A set that is not clean repeats the number, but 2 × 5 at 280 plainly is not there, and 270 has not gone a clean 2 × 5 since August 28 (September 14 stopped at 5 and 2). So the trap bar goes back to 270 on September 29, after the trip, and climbs in fives with no second 10 lb step: 275, the deload at 235, then 280, 285, 290, 295 and 300 on November 17. The squat never met its jump, so it takes it on September 29, 195 if the back was quiet on the 23rd and 24th and 185 if not, and runs the old line one week late to 225 on November 17. Light lower days are refigured at about 82% of the heavy day before them. Pullups are untouched and still close November 8. The leg curl was clean at 120 × 6 and keeps its line.

**On the all-goes-well line the stretch now ends November 17** (November 10 as first written). Everything after that in the file is contingency: the goal weights repeated for the sessions that stall, a deload in the week of November 23, the file ending December 20 and the deadline still December 31. A stall is answered by repeating the weight and sliding the later rows, never by a bigger step to catch up; the future rows get rewritten, the past ones do not.
