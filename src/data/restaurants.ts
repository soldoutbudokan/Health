...
export const RESTAURANT_FOODS: Food[] = [
  ...
  },
  {
    ...
    note: "Estimated September 6, 2026 from the menu description and a photograph of the plate; Il Terrazzo is an independent restaurant and publishes no nutrition, and BC menu labelling only binds chains, so no panel exists to check this against. Built as ~130 g dry fusilli, ~120 g raw ground beef, a tomato-soffritto base, ~45 g cream, ~35 g parmesan split between the sauce and the grating on top, ~70 g mozzarella baked over it, wilted spinach and ~10 g of oil; Atwater lands at 1,352 against 1,360. READ CALORIES AS 1,000-1,750, the widest band in this file, because the portion was reported as big and the two things setting it — how much dry pasta went in, and how heavy the cream and cheese hand was — are both invisible once a dish is baked and capped with melted mozzarella. Sodium 1,300-2,600 mg, with the two cheeses carrying about 1,000 of it before anything is deliberately seasoned and restaurant pasta water salted harder than a home cook salts it. AT 73 G THIS IS THE THIRD-HIGHEST PROTEIN ENTRY IN THE CATALOG AND EASILY THE LEAST EFFICIENT OF THEM, costing 18.6 kcal per gram against the Big Belly chicken bowl 9.2 — the beef and the two cheeses each carry roughly a third of the protein and the cheeses bring most of the fat with it, so this is a pasta dish that happens to be high in protein rather than a protein source; a plate left half-eaten logs as 0.5 rather than sending anyone back to re-estimate the dish.",
