...
export const RESTAURANT_FOODS: Food[] = [
  ...
  },
  {
    ...
    note: "BIGBELLY publishes no nutrition, and bigbellygreek.com was unreachable from this machine on August 20, 2026 — blocked at the network egress proxy — so this is reconstructed from a photograph of the bowl plus menu listings, never from a panel. THIS ROW IS THE BOWL WITHOUT ITS RICE AND WITHOUT THE FRIED PITA, deliberately: the rice is a separate entry so a partly-eaten base logs as a fraction of it, and the pita is separate because it does not always arrive and is easy to leave. REVISED THE SAME DAY IT WAS WRITTEN, ON A PHOTOGRAPH, and the correction is worth keeping because of what it says about the blind draft. That draft was built from review descriptions at ~190 g of chicken, ~120 g of cucumber-tomato-onion-olive salad and tzatziki plus hummus on the side, for 575 kcal and 64.5 g protein. The owner replied that it was much bigger than that and sent a picture, which corrects four things at once: the meat is heaped across the full width of the container rather than scooped into the middle of it; the salad layer is both larger and more varied than assumed — sweetcorn, chickpeas, pickled red onion, greens and cucumber; there is no separate hummus cup, what a blind reconstruction expected as hummus being the chickpeas mixed through; and there are at least two sauces, a tzatziki dollop plus a creamy drizzle over the meat and a thinner red one. Two large deep-fried pita triangles are also visible and are now their own entry. The first draft was not cautious and still came in low, which is the lesson: reviews saying huge portions do not tell you how huge. BUILT NOW as ~260 g of chopped grilled chicken breast with ~8 g of retained oil, ~190 g of the mixed salad layer, and ~125 g of sauces. THE CHICKEN IS STILL THE WHOLE ROW and the band is still wide, because a photograph fixes area and not mass: 210–320 g of cooked meat is 65–99 g of protein and 700–950 kcal for this row. The 260 g comes from a layer covering a roughly 18 cm bowl about 1.5 cm deep at loose-chopped density, which is a volume argument rather than a weighing — one reading off a kitchen scale would still beat all of it. The owner did confirm the revised figures read right (\"the bowl was HUGE\"), which is the best corroboration available short of a scale and is why this entry is not carrying a wider band than it does; it is agreement from the person who ate it, not an independent measurement, so it raises confidence in the 260 g without narrowing the 210–320 g band. Sodium is 1,200–2,300 mg from four places that cannot be separated by looking: the marinade ~680 mg at this portion, the pickles, corn and olives ~450, and the sauces ~580. At the midpoint this is the largest single sodium item in the catalog. WHICH SAUCES WERE ORDERED IS NOT RECORDED, only that there were at least two — BIGBELLY lists feta jalapeno, creamy garlic, greek pesto, greek lemon and others, and taking greek lemon instead of a creamy one would be 60–90 kcal off this row.",
  ...
  },
  {
    ...
    note: "The deep-fried pita triangles that come with a BIGBELLY bowl — two of them, wedge-shaped and about a quarter-pita each, confirmed by photograph on August 20, 2026 after the first draft of the bowl entry guessed they might not be there. Kept out of the bowl entry because they do not always arrive and are the easiest thing in the container to leave. Estimated as ~55 g of pita bread that absorbed ~10 g of frying oil, and the oil is most of the story: the bread alone is ~150 kcal and the fryer adds the other ~90, so how long they sat in it moves this row more than their size does. Band 180–320 kcal. Absorption for fried flatbread runs 10–20% of the bread's weight and 18% was taken here, on the reasoning that these are thin and audibly crisp — a crisper triangle has taken up more oil, not less. Sodium ~300 mg is ordinary bread salt and is the least consequential figure in the row.",
