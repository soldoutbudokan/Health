...
export const RECIPE_FOODS: Food[] = [
  ...
  },
  {
    ...
    macros: { calories: 500, protein: 19, carbs: 36, fat: 30, fiber: 3, sodium: 1575 },
    note: "Based on 4 servings. Add ~200 kcal per cup of rice. PROTEIN IS THE ONE FIGURE HERE THAT DEPARTS FROM UPSTREAM: the recipe's table says 16 g and this entry carries 19 g, changed August 10, 2026 after the ingredient list was checked. The list settles it — one block of paneer, ~300–350 g, across 4 servings. At 18–20 g protein per 100 g that is 54–70 g from the paneer alone, and the potatoes (~7 g), roux (~4 g), onions (~2.5 g) and garlic (~1 g) add ~15 g more, putting a serving at 17–21 g. Working backwards from the stated fat says the same thing: 30 g a serving is 120 g for the pot, of which 2 tbsp oil and 4 roux blocks are ~50 g, leaving ~70 g of paneer fat — about 300 g of paneer, which at its own protein-to-fat ratio cannot yield only 16 g a serving. 19 g is the midpoint of the ingredient-derived range and the figure this entry now uses. Note what did NOT catch this: Atwater passes at 16 g (478 kcal) and at 19 g (490 kcal) against a stated 500, because protein is a small share of a fat-dominated dish — the check has no power here and the ingredient list had to do the work. Calories, carbs and fat are still the upstream table's and reconcile with the ingredients as written, so only protein moved. Fibre and sodium estimated from the ingredient list: potatoes, onions and the roux for the fibre; 4 S&B Golden Curry blocks (the box lists 800 mg sodium per 18 g block) plus a 900 ml carton of commercial vegetable broth for the sodium. This is the saltiest entry in the catalog and the roux is most of it — using water instead of broth takes ~760 mg off.",
  ...
  },
  {
    ...
    macros: { calories: 700, protein: 24, carbs: 80, fat: 30.5, fiber: 3.6, sodium: 1575 },
    note: "Derived by adding the recipe's stated ~200 kcal cup of rice to the curry-only figures — so the protein here moved from 20 g to 24 g on August 10, 2026 purely because the curry-only entry did; see that entry's note for why 16 g upstream became 19 g. The cup of rice is this catalog's own staple row (4.3 g protein, 0.6 g fibre, no sodium). Fibre and sodium estimated from the ingredient list.",
