...
export const RESTAURANT_FOODS: Food[] = [
  ...
  {
    id: "timhortons-plain-bagel-cream-cheese",
    name: "Plain bagel with cream cheese",
    variant: "plain cream cheese",
    brand: "Tim Hortons",
    source: "packaged",
    per: "1 bagel with 1 portion cream cheese",
    macros: {
      calories: 420,
      protein: 12,
      carbs: 61,
    ...
    note: "Tim Hortons' published figures via search summaries on Sep 26, summed from the bagel (290 kcal, 440 mg sodium) and the plain cream cheese (130 kcal, 170–180 mg); the guide and the listing pages were blocked. The Atwater sum is 409. Sesame or everything bagels run 10–40 kcal higher.",
    tags: ["tim hortons", "timmies", "bagel", "cream cheese", "chain", "breakfast"],
  },
  {
  ...
  {
    id: "dunya-chicken-shawarma",
    name: "Chicken shawarma sandwich",
    variant: "toum, pickles, fries inside",
    brand: "Dunya",
    source: "claude",
    per: "1 sandwich (~270 g)",
    gramsPerServing: 270,
    macros: {
      calories: 700,
      protein: 35,
